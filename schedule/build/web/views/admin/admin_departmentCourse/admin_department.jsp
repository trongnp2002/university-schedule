...
<!DOCTYPE html>
<form class="form3" action="/schedule/admin_department/department" method="post">
        <div style="width: 99%">
        ...
        <div class="forData" style="overflow: scroll">
            <table border ="1"  style= "margin-left: 8px; border-collapse: collapse; border: 1px solid black ;font-size: 14px; width: 98%" >
                ...
                <c:forEach  items="${data}" var="department">
                    <tr>
                        <td style="text-align: center">${department.getDepartmentsId()}</td>
                        <td>${department.getDepartmentName()}</td>
                        <td style="text-align: center">
                            <a onclick="checkDeleteAgree('${department.getDepartmentsId()}', 'department')" style="cursor: pointer">delete</a><br>
                        </td>
                    </tr>
                </c:forEach>
            </table> 
    ...
    <div class="popupForm" id="popa">
        <div class="popupContent">
            ...
            <div class="formPop">
                <table border="0">
                    <tr><td colspan="2"><h3>ADD DEPARTMENT</h3></td></tr>
                    <tr>
                        <td>Department name: </td>
                        <td><input type="text" name="name" id='endTimeCreate'></td>
                    </tr>
                    <tr>
