...
<html>
    ...
    <body>
        ...
        <form id="form3" action="/schedule/admin_student/select" method="post">
            <div class="forInput" >
                <input id="theIdSel"class="theId"type="text" name="search" value="${input}">
                <select id="selOption" class="sel" name="option">
                ...
                <br>
                <div class="subhovdel" >
                    <input class="subdel " type="submit" name="sub" value="SUBMIT">
                </div>
            </div>

            <c:if test="${data != null && data.size() > 0}">
                <div id="forData" style="overflow: scroll">
                        ...
                        <c:forEach  items="${data}" var="student">
                            <tr>
                                ...
                                <td style="text-align: center">
                                    ...
                                    <br>
                                    <a onclick="checkDeleteAgree('${student.getStudentID()}')" style="cursor: pointer">delete</a><br>
                                </td>
                            </tr>
                        </c:forEach>
                    </table> 
            ...
            <div class="popupForm" id="popf">
                <div class="popupContent">
                    <div class="popupHeader">
                        <i class="ti-close popClose" onclick="closePop()"></i>
                    </div>
